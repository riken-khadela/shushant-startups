...
class SUMMARY(object):
    ...
    def summary_process_logic(self,url,dict):
        ...
        if isloaded:
            ...
            file_name = "/media/rk/workspace/shushant/crunchbase_logged_in.html"
            ...
            new_organization_name=data.find('span',{'class':'entity-name'}).text.strip()
            ...
            new_organization_logo=data.find('profile-v3-header-logo').find('source').get('srcset').split(' ')[0]
